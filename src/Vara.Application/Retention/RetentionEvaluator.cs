...
/// each of that tier's calendar buckets, up to the tier's configured count. Anything
/// not retained by any tier is eligible for removal. See design.md's "Retention/prune
/// algorithm" and the retention-pruning spec's "Tiered retention evaluation".
/// </summary>
public sealed class RetentionEvaluator
{
    ...
    /// <summary>Snapshots that are not retained by any configured tier, and are not currently in progress.</summary>
